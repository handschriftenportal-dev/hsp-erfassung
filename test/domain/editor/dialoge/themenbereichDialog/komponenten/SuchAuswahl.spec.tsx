...
import { SuchAuswahl } from 'src/domain/editor/dialoge/themenbereichDialog/komponenten/SuchAuswahl'
...
describe('Themenbereich Such-Auswahl', () => {
  ...
  it('can add search result', async () => {
    ...
    expect(dispatch).toHaveBeenLastCalledWith({
      type: 'addBegriffe',
      payload: { id: begriff.identifier.id },
    })
  })
      ...
      <TestContext>
        <SuchAuswahl
          state={{
            ...
            auswahl: [{ id: begriff.identifier.id }],
          }}
          dispatch={dispatch}
          api={api}
        />
