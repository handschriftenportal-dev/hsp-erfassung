...
type Mapping = (props: RenderElementProps) => React.JSX.Element
...
const components: OptionalMapping = (props: RenderElementProps) => {
...
const elements: OptionalMapping = (props: RenderElementProps) => {
  switch (props.element.data_origin) {
    ...
    case TEI_ELEMENT_COLLECTION:
      return (
        <Collection
          element={props.element as CollectionElement}
...
const normdataElements: OptionalMapping = (props: RenderElementProps) => {
  switch (props.element.data_origin) {
    case TEI_ELEMENT_COLLECTION:
    case TEI_ELEMENT_IDNO:
    case TEI_ELEMENT_ALT_IDENTIFIER:
    ...
    case 'volltext':
      return (
        <NormdatenAnsicht
          element={props.element as VolltextEditorElement}
          attributes={props.attributes}
        >
          {props.children}
        </NormdatenAnsicht>
